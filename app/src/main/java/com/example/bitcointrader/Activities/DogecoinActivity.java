...
public class DogecoinActivity extends AppCompatActivity implements ICoinActivity, IFragmentToActivity {
    ...
    public void getActualValue() {
        requestRetriever.getCoin(Urls.DOGECOIN + "/getActual", this.getApplicationContext(), new IRequestCallBack<Coin>() {
            @Override
    ...
    public void getValues() {
        requestRetriever.getCoin(Urls.DOGECOIN + "/getMax", this.getApplicationContext(), new IRequestCallBack<Coin>() {
            @Override
            public void onSuccess(Coin coin) {
                max = coin;
            }
        });
        requestRetriever.getCoin(Urls.DOGECOIN + "/getAnualMax", this.getApplicationContext(), new IRequestCallBack<Coin>() {
            @Override
            public void onSuccess(Coin coin) {
                anualMax = coin;
            }
        });
        requestRetriever.getCoin(Urls.DOGECOIN + "/getAnualMin", this.getApplicationContext(), new IRequestCallBack<Coin>() {
            @Override
            public void onSuccess(Coin coin) {
                anualMin = coin;
            }
        });
        requestRetriever.getCoinList(Urls.DOGECOIN + "/getLastMonth", this.getApplicationContext(), new IRequestCallBack<List<Coin>>() {
            @Override
    ...
    public void communicate(String data) {
        requestRetriever.getCoinList(Urls.DOGECOIN + "/getLastX/" + data, getApplicationContext(), new IRequestCallBack<List<Coin>>() {
            @Override
            public void onSuccess(List<Coin> coins) {
                chartCoins = new ArrayList<>();
                chartCoins.addAll(coins);
