...
public class LitecoinActivity extends AppCompatActivity implements ICoinActivity, IFragmentToActivity {
    ...
    public void getActualValue() {
        requestRetriever.getCoin(Urls.LITECOIN + "/getActual", this.getApplicationContext(), new IRequestCallBack<Coin>() {
            @Override
    ...
    public void getValues() {
        requestRetriever.getCoin(Urls.LITECOIN + "/getMax", this.getApplicationContext(), new IRequestCallBack<Coin>() {
            @Override
            public void onSuccess(Coin coin) {
                max = coin;
            }
        });
        requestRetriever.getCoin(Urls.LITECOIN + "/getAnualMax", this.getApplicationContext(), new IRequestCallBack<Coin>() {
            @Override
            public void onSuccess(Coin coin) {
                anualMax = coin;
            }
        });
        requestRetriever.getCoin(Urls.LITECOIN + "/getAnualMin", this.getApplicationContext(), new IRequestCallBack<Coin>() {
            @Override
            public void onSuccess(Coin coin) {
                anualMin = coin;
            }
        });
        requestRetriever.getCoinList(Urls.LITECOIN + "/getLastMonth", this.getApplicationContext(), new IRequestCallBack<List<Coin>>() {
            @Override
